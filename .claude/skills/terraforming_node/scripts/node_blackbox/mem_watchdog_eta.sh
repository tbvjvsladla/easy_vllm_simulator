...
#
#   ★ 킬 대상 선별(@vllm 광역)은 2026-09-04(CP0 · plan_26090415 §3.3)에 **한 번 좁혔다** —
#     이미지의 레지스트리·조직 경로를 벗기고 저장소 이름만 본다. 근거·음성대조는 아래
#     BB_TARGET_PREDICATE_V1 블록 주석에 있다(세 워치독 공유 · parity tripwire 대상).
#

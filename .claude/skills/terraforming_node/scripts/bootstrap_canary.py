...
TASK_COMMON = (
    ...
    "② output/<topology>/manifest.yaml 의 self_role·terraforming Flag·gpus_per_node 와 "
    "node_role_contract 가 해소한 sub_mode·rank를 그대로 보고(SSH는 endpoint 인증만 담당), "
    "Agent_Card.json 이 있으면 capability metadata로만 목록을 보고 "

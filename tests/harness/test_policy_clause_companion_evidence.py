...
(scripts/policy_registry.py) rejects a clause whose evidence is entirely prose (`.md`) -- prose
...
(`ClassName.method_name`, AST-verified by scripts/policy_registry.py) on this file as an

...
**triplet**
- `output/single/configs/nv4-dev-1m.yaml`
- `output/single/configs/nv4-dev-1m.sh`
- `output/single/envs/.env.nv4-dev-1m`
...
- **triplet — 적용.** 서빙에 원리적으로 필수다. 이 형상의 핵심은 세 줄이다 —
  `kv-cache-memory-bytes`(24 GiB 절대클램프) · `max-model-len: 1048576`(YaRN factor 4) · `enforce-eager`.

...
scripts/evidence_publisher.py so no second, hand-duplicated naming implementation exists inside
the publisher.
...
def _self_test():
    ...
    assert kst_tokens("2026-99-99T99:99:99Z") == ("NA", "00", "00")  # shape matches, calendar doesn't

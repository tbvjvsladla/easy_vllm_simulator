#!/usr/bin/env python3
"""scripts/providers/claude_code.py -- Claude Code adapter (Phase 6, plan_26072506).
...
agent-control-adapter.md` -- see tests/harness/test_skill_contracts.py::TestClaudeCommandsIsolatedToAdapter.
scripts/agent_control.py stays provider-neutral and only calls the two pure functions below.

...
| `hint/0.19.1/gpt-oss-120b/gb10-single` | 0.19.1 | gpt-oss-120b | gb10-single | single 1노드 | active | hint/0.26.0/gpt-oss-120b/gb10-single | 2026-09-01 | 0.19.1 prebuilt wheel 로 gpt-oss-120b(MXFP4)를 단일 GB10 에 서빙 — auto=TRITON_ATTN+MARLIN 정상 · 34.55 t/s(MBU 77.9%) · 성능 PASS |

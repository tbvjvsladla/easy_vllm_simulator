...
- A2A 정체성 게이트: policy:A2A_IDENTITY_PROOF_FAIL_CLOSED. 정체성은 branch·topology·`output/`이 아니라 endpoint-local reciprocal enrollment와 signed attempt envelope가 증명한다. 증명은 실행 허가가 아니며 HITL·배정·scope가 별도 판정한다.
